...
class EmbeddingRequest(BaseModel):
    content: str  # URL para o arquivo na nuvem
    id_knowledge: str
    id_company: str
...
@router.post("/generate-embeddings-txt/")
async def generate_embeddings(request: EmbeddingRequest):
    try:
        ...
        # Obter os dados brutos do arquivo
        ...
        # Decodificar o conteúdo para texto
        file_content = raw_data.decode(encoding)

        # Normalizar o texto para garantir consistência
        file_content = unicodedata.normalize("NFKC", file_content)

        # Debug: Exibir o início do texto para verificar correção
        print(f"Texto inicial: {file_content[:200]}...")

        # Dividir o conteúdo do arquivo em pedaços
